...
if(array_key_exists("home",$_POST)){
    dashboard();
} elseif(array_key_exists("add_std",$_POST)){
    addstandard();
       ...
       <?php   echo "<table>
               ...
               while($row = mysqli_fetch_assoc($result1)){
                   ...
                   <tr>
                       ...
                       <?php if ($row3['access_type'] == "Admin" || $row3['access_type'] == "Teacher"){?>
                            <td><button><a href="standard_edit.php?edit=<?php echo $row['standard_id']; ?>">Edit</a></button></td>
                            <td><button><a href="standard_delete.php?delete=<?php echo $row['standard_id']; ?>">Delete</a></button></td>
                       <?php } ?>
                   </tr>
         <?php  }
           echo "</table>";?>
